...
function premier_register_theme_customizer( $wp_customize ) {
	...
	$list_featured_text_boxes = array(
        ...
        array('four', __('Four', 'premier'), __('Service Box Four', 'premier')),
        array('five', __('Five', 'premier'), __('Service Box Five', 'premier')),
        array('six', __('Six', 'premier'), __('Service Box Six', 'premier')),
        array('seven', __('Seven', 'premier'), __('Service Box Seven', 'premier')),
        array('eight', __('Eight', 'premier'), __('Service Box Eight', 'premier')),
        array('nine', __('Nine', 'premier'), __('Service Box Nine', 'premier')),
	);
